...
@Mod("chillax")
public class ChillaxMod {
	public static final Logger LOGGER = LogManager.getLogger(ChillaxMod.class);
	public static final String MODID = "chillax";

	public ChillaxMod(IEventBus modEventBus) {
